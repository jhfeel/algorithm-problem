...
<p><lighter data-id="lgt5768214676827927" data-bundle-id="5768214676827927" data-slot-id="0" style="background-color: rgb(244, 220, 97);">주어진 네 개의 점을 두 개씩 이었을 때</lighter>, 두 직선이 평행이 되는 경우가 있으면 1을 없으면 0을 return 하도록 solution 함수를 완성해보세요.</p>
